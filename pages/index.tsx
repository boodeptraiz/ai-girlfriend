  ...
  return (
    <div className='p-4 max-w-md mx-auto h-screen flex flex-col'>
      ...
      <div className='flex mt-2 gap-2'>
        <input value={input} onChange={e => setInput(e.target.value)} className='flex-1 p-2 rounded bg-gray-800 text-white' placeholder='Nhắn gì đó cho EM...' />
        <button onClick={sendMessage} className='bg-blue-500 px-4 py-2 rounded text-white'>Gửi</button>
      </div>
    </div>
  );
}
